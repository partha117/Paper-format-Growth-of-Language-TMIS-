\subsection{RQ2: Predecessor language of interest of the respondents of new languages}
\label{RQ5}
...
% Therefore, it is evident that the new languages can get crucial support in their \emph{evolving state} if it has a predecessor language.
