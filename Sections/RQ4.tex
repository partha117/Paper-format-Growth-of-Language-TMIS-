...
To compare growth, we plot the median time to get the first answer and the accepted answer of new languages, one top-tier language (in this case Java)\textcolor{blue}{, and mid-category language (Python)}.
\begin{figure}[htbp]
